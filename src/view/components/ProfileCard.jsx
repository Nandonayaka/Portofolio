...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, #1e293b 0%, #3b82f644 100%)';
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(74, 144, 255, 0.67)',
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            {/* Avatar content */}
            <div
              className="w-full h-full overflow-hidden backface-hidden"
              style={{
            ...
            >
              <img
                className="w-full h-full object-cover absolute inset-0 backface-hidden will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc((var(--pointer-from-left) - 0.5) * 6px)) translateY(calc((var(--pointer-from-top) - 0.5) * 6px)) translateZ(0)',
                  borderRadius: cardRadius
                }}
                onError={e => {
                  const t = e.target;
